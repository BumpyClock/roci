...
fn payload_name(payload: &AgentRuntimeEventPayload) -> &'static str {
    match payload {
        ...
        AgentRuntimeEventPayload::HumanInteractionRequested { .. } => "human_interaction_requested",
        AgentRuntimeEventPayload::HumanInteractionResolved { .. } => "human_interaction_resolved",
        AgentRuntimeEventPayload::HumanInteractionCanceled { .. } => "human_interaction_canceled",
        ...
        AgentRuntimeEventPayload::TempFileWritten { .. } => "temp_file_written",
