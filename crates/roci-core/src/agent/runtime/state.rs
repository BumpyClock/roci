...
use super::{
    AgentRuntime, AgentRuntimeError, AgentRuntimeEventPayload, AgentSnapshot, AgentState,
    RuntimeCursor, RuntimeSnapshot, RuntimeSubscription, SessionResourceSnapshot, ThreadId,
    ThreadSnapshot,
};
...
impl AgentRuntime {
    ...
    pub async fn read_thread(
        ...
        self.semantic.read_thread(thread_id)
    }
