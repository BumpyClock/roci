...
- [Codex Loop Evaluation Decisions](./codex-loop-evaluation.md)
  - read_when: revisiting prompt assembly, planning-tool surface, or compaction strategy (tsq-wag94sf4 closed).
